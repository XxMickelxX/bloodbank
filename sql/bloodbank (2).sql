...
--
-- Host: 127.0.0.1
-- Generation Time: May 21, 2023 at 11:12 PM
...
--
-- Dumping data for table `donaterequest`
--

INSERT INTO `donaterequest` (`reqid`, `DonerID`, `donatedate`, `hid`, `status`) VALUES
(41, 1, '2023-05-23', 0, 'Pending');
...
--
ALTER TABLE `donaterequest`
  MODIFY `reqid` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;
